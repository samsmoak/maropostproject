...
function ResultProducts() {
	...
	return (
		<div className='w-full flex justify-center  '>
			<div className=' grid xs:grid-cols-2 xs:gap-2 xs:px-2 sm:grid-cols-3 sm:gap-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-4 xxl:grid-cols-6  xxl:gap-6  gap-y-6'>
